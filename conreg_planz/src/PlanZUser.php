...
/**
 * @file
 * Contains \Drupal\conreg_planz\PlanZUser.
 */
...
class PlanZUser
{
   ...
   * @param bool $reset If true, reset member password.
   * 
   */
   ...
   * @param Connection $planZCon Connection to PlanZ database
   ...
   * @param Connection $planZCon The connection to the PlanZ database
   * @param string $publicationName The name to save to the pubsname field
   * @param string $sortingName The name to save to the sortedpubsname field
   ...
   * @param Connection $planZCon Connection to PlanZ database
   * @param int $role The ID of the role to add
   ...
   * @param int $chars Number of characters length for password
   * @return string A random password
   */
  function generatePassword(int $chars): string
  {
