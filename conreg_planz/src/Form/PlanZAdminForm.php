...
/**
 * @file
 * Contains \Drupal\conreg_planz\Form\PlanZAdminForm
 */
...
class PlanZAdminForm extends FormBase
{
   ...
   * @param int $memberNo The member number being added
   * @param boolean $override If true, add member even if they don't meet criteria
   * @param boolean $reset If true, reset the user's password
   * @param boolean $dontEmail If true, don't send email notification
