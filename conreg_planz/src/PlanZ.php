...
/**
 * @file
 * Contains \Drupal\conreg_planz\PlanZ.
 */
...
class PlanZ
{
   ...
   * @param int &$count Count of members
   ...
   * @param PlanZUser $user The PlanZ user to send invite to
   */
  public function sendInviteEmail(PlanZUser $user)
  {
    ...
    $extraTokens = ['[planz_user]' => $user->badgeId,
