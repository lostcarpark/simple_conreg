...
class PlanZ {
  ...
  public readonly bool $generatePasswordResetLink;
  public readonly int $passwordResetExpiry;
  public readonly bool $generatePassword;
  public readonly array $roles;
  public readonly bool $interestedDefault;
  public readonly string $planZUrl;
  public readonly bool $useOptions;
  ...
  public function __construct(ImmutableConfig|NULL $config = NULL) {
    ...
    $this->generatePasswordResetLink = $config->get('generate_password_reset_link') ?: FALSE;
    $this->passwordResetExpiry = $config->get('password_reset_expiry') ?? 604800;
    ...
    $this->useOptions = $config->get('use_options') ?? FALSE;
    $this->optionFields = $config->get('option_fields') ?? [];
    $this->autoAdd = $config->get('auto.add') ?: FALSE;
